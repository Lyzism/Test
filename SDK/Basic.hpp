...
namespace Offsets
{
	constexpr int32 GObjects          = 0x04A33960;
	constexpr int32 AppendString      = 0x01034420;
	constexpr int32 GNames            = 0x049F7600;
	constexpr int32 GWorld            = 0x04B7B300;
	constexpr int32 ProcessEvent      = 0x01224250;
